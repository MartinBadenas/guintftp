...
/* Internal functions */
int16_t move_right_insert(int16_t position, char charAdd, char *text, int16_t textlen);
int16_t move_right_put_after(int16_t position, char charAdd, char *text, int16_t textlen);
